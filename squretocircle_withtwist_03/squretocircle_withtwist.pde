...
void buildModel()
{
  ...
  float[] sizes = {173,   30, 74, 30, 72, 30, 100, 30, 58, 15,  1};
  int[] iterations =     {  9, 2, 2,  3,  4, 5, 5, 4, 4, 1};
  int[] holdIterations = {  0,  1, 12,  2,   9,  1, 7,  1,  2,  0};
...
//    rotation += sin(t)*0.000+sin(tt)*0.048;
    rotation += sin(tt)*0.341*sin(t)*1.000;
    t += 0.012;
    tt += 0.54;
  }
